...
def apply_medium_match_mastering(file_path, weight, amp, pitch_val):
    """इको को 'मीडियम' और '100% मैच' लेवल पर सेट करना"""
    sound = AudioSegment.from_wav(file_path)
    
    # एमप्लीफायर और पिच कंट्रोल
    sound = sound + amp 
    ...
    # ✅ 100% मैच फिक्स: मीडियम इको (Medium Ambience)
    # यह न गूँजेगा, न ही आवाज़ को सूखा रखेगा
    echo = sound - 30 
    sound = sound.overlay(echo, position=200) 
    
    # आवाज़ को गहरा बनाने के लिए फिल्टर
    sound = sound.low_pass_filter(3950)
    
    final_path = "shriram_100percent_match.wav"
...
def generate_voice(text, voice_sample, speed, human_feel, weight, amp, pitch_val, progress=gr.Progress()):
    ...
    for i, chunk in enumerate(chunks):
        ...
        tts.tts_to_file(
            ...
            speed=speed, repetition_penalty=11.5, temperature=human_feel,
    ...
    return apply_medium_match_mastering("combined.wav", weight, amp, pitch_val)

# 🎨 100% मैच UI
with gr.Blocks(theme=gr.themes.Soft(primary_hue="orange")) as demo:
    gr.Markdown("# 🚩 श्रीराम वाणी - 100% मैच मीडियम मास्टर")
    ...
    with gr.Row():
        ...
        with gr.Column(scale=1):
            ...
            with gr.Accordion("⚙️ मास्टर कंट्रोल (परफेक्ट मैच)", open=True):
                ...
                human_s = gr.Slider(label="इंसानी स्पर्श", minimum=0.5, maximum=1.0, value=0.92)
    ...
    out = gr.Audio(label="100% मैच आउटपुट", type="filepath", autoplay=True)
