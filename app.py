...
# ३. हकलाहट रोकने के लिए मास्टर टेक्स्ट क्लीनर
...
# ४. मुख्य इंजन - 'माइक्रो-चंकिंग' तकनीक (LOCKED)
def generate_shiv_v1_5(text, up_ref, git_ref, speed_s, pitch_s, use_silence, use_clean, progress=gr.Progress()):
    ...
    # ⚡ हकलाहट फिक्स: वाक्यों को कोमा (,) और पूर्ण विराम (।) पर छोटे टुकड़ों में तोड़ना
    chunks = re.split(r'([,।!?॥\n])', p_text)
    ...
    for i, chunk in enumerate(valid_chunks):
        ...
        # 🔒 सबसे सटीक XTTS सेटिंग्स: Penalty 1.2, Temp 0.1
...
# ५. दिव्य UI (वर्ड काउंटर के साथ)
with gr.Blocks(theme=gr.themes.Soft(primary_hue="orange")) as demo:
    gr.Markdown("# 🚩 शिव AI (Shiv AI) v1.5 — श्री राम नाग")
    gr.Markdown("### 🔒 ब्रह्मास्त्र अपडेट: हकलाहट १०००% बंद | वर्ड काउंटर")
